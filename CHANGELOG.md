...
- Handbook page `security.md` — threat model, GHSA-pending advisory, four-layer defense in depth, SSH port-forwarding recipe, auth-middleware mode matrix, anti-patterns. Single surface for "I want to expose this safely."
