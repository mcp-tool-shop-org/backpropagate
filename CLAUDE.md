...
- 2416 tests in tests/ (2409 passed + 7 skipped; pinned 2026-05-30 post-Stage-A), 50% coverage floor (single source of truth: `[tool.coverage.report].fail_under = 50` in pyproject.toml; ci.yml reads it via tomllib so the two surfaces stay in lockstep)
