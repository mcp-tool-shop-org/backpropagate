...
- `ui_app/` + `rxconfig.py` — Reflex (Radix UI) web UI shipped in v1.1.0 (canonical; optional, requires `[ui]` extra)
- `ui_gradio_legacy.py` + `theme_gradio_legacy.py` — v1.0 Gradio implementation kept as reference; removed in v1.2
