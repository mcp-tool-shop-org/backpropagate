...
- [x] `[all]` Version in manifest matches git tag (2026-02-27) — 1.0.0 = v1.0.0
- [x] `[all]` Dependency scanning runs in CI (ecosystem-appropriate) (2026-02-27) — Bandit, pip-audit, Semgrep, Trivy, TruffleHog
